...
describe("Party", function () {
  ...
  it("Should navigate to create party", function () {
    return new Promise((resolve, reject) => {
      ...
      browser
        .wait(
          until.elementLocated(By.xpath("//div[@id='alert-dialog-title']")),
          1000
        )
        .then(() => resolve())
        .catch((err) => reject(err));
  ...
  it("Should create party", function () {
    return new Promise((resolve, reject) => {
      browser
        .wait(until.elementLocated({ id: "tagsbox" }), 1000)
        .then(() =>
          browser
            .findElement(
              By.xpath(
                "/html[1]/body[1]/div[4]/div[3]/div[1]/div[2]/div[1]/div[1]/ul[1]/li[1]/input[1]"
              )
            )
            .sendKeys("limbo")
        )
        .then(() =>
          browser
            .findElement(
              By.xpath("//body/div/div/div/div/div/div/ul/li/input[1]")
            )
            .sendKeys(Key.DOWN)
        )
        .then(() =>
